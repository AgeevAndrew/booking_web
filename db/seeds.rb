...
Company.create(name: 'ИП Свиридов Ф.Т.',
							 ...
							 delivery: { cost: 150, free_shipping: 800, pickup_discount: 10, period: { start: '12:00 Vladivostok', end: '19:30 Vladivostok' } },
							 contact_info: { phone: '+7(4212)776025', email: 'info@chixx.ru' })
...
Product.create(
	...
	company_id: Company.first.id,
	title: 'Шрирача Hot!',
	brief: 'НОВИНКА! Крылья Шрирача порадуют пронзительно огненным острым вкусом, тщательно промаринованные и обжаренные, они отлично подойдут любителям блюд "погорячее"!',
...
Product.create(
	...
	company_id: Company.first.id,
	title: 'Коул слоу',
	brief: 'Легкий салат с основой из свежей моркови, капусты, заправляем сметанным соусом с винным уксусом и добавлением классической горчицы и черного перца.',
...
Product.create(
	category_id: Category.seventh.id,
	company_id: Company.first.id,
...
Product.create(
	category_id: Category.eighth.id,
	company_id: Company.first.id,
	title: '7up',
