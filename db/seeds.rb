...
Category.create(name: 'Кебабы', icon_type: 'icon_kebab', description: '')
...
Product.create(
	...
	company_id: Company.first.id,
	title: 'Чили XL',
	brief: 'Бургер бомба = мясная чили начинка из говяжьего фарша с фасолью, кукурузой, рисом и перчиком чили + приличная сочная говяжья котлета с сыром.',
