ActiveRecord::Base.transaction do
  ...
  Product.create(
  	...
  	description: 'Классический бургер с говяжьей котлетой, салат Коул Слоу, картошка фри с кетчупом, бутылка напитка на выбор, 180 гр. /100 гр. /120 гр. /150 гр. /600 мл',
  ...
  Product.create(
  	...
  	description: 'Классический бургер с говяжьей котлетой, салат Коул Слоу, картошка фри с кетчупом, бутылка напитка на выбор, 200 гр. /100 гр. /120 гр. /150 гр. /600 мл',
  ...
  Product.create(
  	...
  	description: 'Ассорти из обжаренных вкусняшек к пиву - картофель фри, свежеобжаренные чипсы, луковые кольца (10 шт.), сырные палочки (5 шт.) + 2 соуса. 120 гр./ 50 гр. / 130 гр. / 5 шт. / 50 + 50 мл.',
  ...
  Product.create(
  	...
  	description: 'А можно все попробовать? Можно! Ассорти из куриных крылышек – по 4 кусочка крыльев Американо, Спайси, Терияки, Пармезан и Медово-горчичные. 180 гр. /100 гр. /120 гр. /150 гр. /600 мл',
